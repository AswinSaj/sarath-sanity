                ...
                {poem.photo ? (
                    <div className="relative w-full h-full">
                        ...
                        <div className="hidden lg:flex absolute inset-0 bg-black/50 items-center justify-center p-4 md:p-8">
                            <div className="text-center text-white">
                                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold">{poem.title}</h3>
                            </div>
                        </div>
                    </div>
                ) : (
                    <div className="flex h-full w-full items-center justify-center bg-black text-white">
                        <div className="text-center p-4 md:p-8 max-w-lg mx-auto">
                            <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6">{poem.title}</h3>
                            <div className="text-gray-300 leading-relaxed text-center">
                                <PortableText
                                    value={poem.content}
                                    components={{
                                        block: {
                                            normal: ({ children }) => (
                                                <div className="mb-3 md:mb-4 leading-relaxed text-sm md:text-base">{children}</div>
                                            ),
                                        },
                                        marks: {
                                            strong: ({ children }) => (
